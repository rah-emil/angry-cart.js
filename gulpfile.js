...
let paths = {
	...
	scripts: {
		src: [
			...
			baseDir + '/js/angry-cart.js' // angry-cart.js. Always at the end
		],
		dest: baseDir + '/js',
	},

	styles: {
		src:  baseDir + '/' + preprocessor + '/angry-cart.*',
		dest: baseDir + '/css',
	},
	...
	cssOutputName: 'angry-cart.min.css',
	jsOutputName:  'angry-cart.min.js',
